...
<html>
<head>
<title>Literacy a Education Category Flat Bootstrap responsive Website Template | Typography :: w3layouts</title>
	...
	<div class="header" id="movetop">
		<div class="container">
			<div class="header-top">
				<p><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span>Phone:</p>
				<div class="logo">
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
							  <ul class="nav navbar-nav">
								...
								<li class="active"><a href="typography.php">Short codes</a></li>
			...
			<div class="container">
				...
				<div class="footer-nav">
					<ul>
						...
						<li><a href="about.php">ABOUT</a></li>
						<li><a class="scroll" href="#movetop">SHORT CODES <span class="sr-only">(current)</span></a></li>
						<li><a href="gallery.php">GALLERY</a></li>
						<li><a href="blog.php">Blog</a></li>
						<li><a href="contact.php">Contact Us</a></li>
					</ul>
