					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
							<nav class="cl-effect-20" id="cl-effect-20">
								...
								<li ><a href="@dmin.php"><span data-hover="Admin">Admin</span></a></li>
									<li class="active"><a href="tampil.php"><span data-hover="Tampil">Tampil</span></a></li>
...
<div class="services">
		<div class="container">
			...
			<div class="services-grids">
				<h3><span>Politeknik Kesehatan</span>Tampil</h3>
<?php
include('conn.php')
	?>
	<br/>
	...
	<table>
		...
		?>
			<td width="10" align="center">
				...
				<img src="upload/<?php echo $row['nama_file'];?>" alt="" width="300" height="200" border="0"/>
				</a>
		...
		?>
				...
				<p>&nbsp;</p>
				<h4>Selamat datang di website Politeknik kesehatan kemenkes Bandung jurusan keperawatan</h4>
		  </div>
					</div>
					</div>
<!-- banner-bottom -->
