...
<div class="navbar">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </a> <a class="" href="index.php"><img src="img/poltekkes.png" alt="" width="71" height="71" border="0"></a>
      <ul class="nav nav-collapse pull-right">
<li><a href="http://tugas.jurwatbandung.com/dosen/index.php?p=home"><i class=""></i>Home</a></li>
        <li><a href="http://tugas.jurwatbandung.com/elearning_jurwatbandung/administrator/"><i class=""></i>E-Learning</a></li>
        
        <li><a href="http://tugas.jurwatbandung.com/elsphpwebquiz_gold_lite_1.5.1"><i class=""></i>Quiz</a></li>
        <li><a href="index.php?p=logout"><i class=""></i>Logout</a></li>
      </ul>
