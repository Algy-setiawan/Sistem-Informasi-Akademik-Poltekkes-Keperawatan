...
<div class="container work">
  ...
  <div class="entry">
		...
		<tr>
                    ...
                    <th width="100"><span class="style4">Tgl Upload</span></th>
					 <th width="158"><span class="style4">Nama Dosen</span></th>
					 <th width="175"><span class="style4">Mata Kuliah</span></th>
					 <th width="75"><span class="style4">Kelas</span></th>
                    <th width="223"><span class="style4">Nama Tugas</span></th>
                    <th width="100"><span class="style4">Ukuran</span></th>
          </tr>
                <?php
				include('config.php');
				
				$sql = mysql_query("SELECT * FROM download ORDER BY mata_kuliah , kelas asc");
