...
if ($_GET['module']=='home'){
  ...
  echo "<p>Hai <b>$_SESSION[namalengkap]</b>, Selamat datang di halaman Administrator E-learning Jurwat Bandung<br>
  ...
  echo "<p>Hai <b>$_SESSION[namalengkap]</b>,  selamat datang di halaman Administrator.<br>
          ...
          }echo "</td><td>NIDN</td>  <td> : $p[nip]</td><tr>
   ...
   //mata pelajaran
   echo"<form><fieldset>
              <legend>mata kuliah yang anda Ambil</legend>
              <dl class='inline'>
  ...
  if (!empty($cek_mapel)){
    ...
    echo "</table></dl></fieldset></form>";
      ...
      echo"<br><br>Tidak Ada Mata Kuliah Yang Di Ampu";
  }
