...
<header id="top">
	<div class="container_12 clearfix">
		<div id="logo" class="grid_5">
			...
			<a id="site-title" href="dashboard.html"><span>ADMINISTRATOR</span><br><span>E-Learning Jurwat Bandung</span></a>
		</div>
			...
			<ul id="mainmenu" class="sf-menu">
				...
				<li><a href="#">Manajemen Users</a>
					<ul>
						...
						<li><a href="?module=admin&act=pengajar">Dosen</a></li>
					</ul>
				</li>
                                <li><a href="#">Setting</a>
					<ul>
			...
			<div class="box menu">
				...
				<section>
					<?php
                                        ...
                                        elseif ($_SESSION[leveluser]=='pengajar'){
                                            echo "Anda masih dalam keadaan login sebagai : <b>Dosen</b>. <br>";
                                            echo "Jangan lupa untuk <a href=logout.php><b>Logout</b></a> sebelum meninggalkan website ini.";
                                        }
                                        ?>
				</section>
...
<footer id="bottom">
	<section class="container_12 clearfix">
		...
		<div class="grid_6 alignright">
			Copyright &copy; 2011 <a href="#">Jurwat Bandung</a>
		</div>
	</section>
</footer>
