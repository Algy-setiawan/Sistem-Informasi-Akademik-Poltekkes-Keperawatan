  ...
  default:
      ...
      if ($_SESSION[leveluser]=='admin'){    
        ...
        echo "<br><br><table id='table1' class='gtable sortable'><thead>
          <tr><th>no</th><th>judul</th><th>kelas</th><th>Matkul</th><th>tgl buat</th><th>pembuat</th><th>waktu</th><th>Info</th><th>terbit</th><th>aksi</th></tr></thead>";
    ...
    $tampil_topik = mysql_query("SELECT * FROM topik_quiz WHERE pembuat = '$_SESSION[idpengajar]'");
        echo "<h2>Tugas Online</h2><hr>
          <input class='button blue' type=button value='Tambah Topik' onclick=\"window.location.href='?module=quiz&act=tambahtopikquiz';\">";
        echo "<br><br><table id='table1' class='gtable sortable'><thead>
          <tr><th>No</th><th>Judul</th><th>Kelas</th><th>Matkul</th><th>Tgl Buat</th><th>Lama Pengerjaan</th><th>Info</th><th>Terbit</th><th>Aksi</th></tr></thead>";
        ...
        echo "<tr><td>$no</td>
             ...
             <td><a href='?module=quiz&act=edittopikquiz&id=$r[id_tq]' title='Edit'><img src='images/icons/edit.png' alt='Edit' /> | 
                 ...
                 <input type=button class='button small white' value='Buat Tugas OnLine' onclick=\"window.location.href='?module=buatquiz&act=buatquiz&id=$r[id_tq]';\"></input><br>
                <input type=button class='button small white' value='Daftar Tugas OnLine' onclick=\"window.location.href='?module=daftarquiz&act=daftarquiz&id=$r[id_tq]';\"></input><br>
    ...
    elseif ($_SESSION[leveluser]=='siswa'){
        ...
        if (!empty($cek_mapel)){
            echo"<br><b class='judul'>Tugas OnLine</b><br><p class='garisbawah'></p>
            <table>
...
case "daftarsiswayangtelahmengerjakan":
    if ($_SESSION[leveluser]=='admin'){
        ...
        if (!empty($cek_siswa)){
        echo "<h3>Mahasiswa yang telah Mengerjakan Tugas</h3><hr>";
        ...
        while ($t=mysql_fetch_array($siswa_yangmengerjakan2)){
            ...
            echo "<tr><td>$no</td>                      
                      ...
                      if ($t[dikoreksi]=='B'){
                          ...
                          echo "
                          <td><a href=$aksi?module=quiz&act=editsiswayangtelahmengerjakan&id=$t[id]&id_siswa=$s[id_siswa]&id_tq=$_GET[id]>Hapus Mahasiswa</a> |
    ...
    elseif ($_SESSION[leveluser]=='pengajar'){
        ...
        echo "<form><fieldset>
              <legend>Mahasiswa yang telah Mengerjakan Tugas</legend>
              <dl class='inline'>";
         echo "<br><div class='information msg'>
        Pilih Aksi <b>Hapus Siswa</b> jika ingin mereset Mahasiswa yang telah Mengerjakan Tugas.<br>
        Hanya jawaban soal Essay yang bisa di koreksi.<br>
        Penilaian Soal Pilihan Ganda Sistem yang mengerjakan.</div>";
        ...
        elseif (!empty($pilganda) AND empty($esay)){
         echo "<form><fieldset>
              ...
              <dl class='inline'>";
         echo "<br><div class='information msg'>
        Pilih Aksi <b>Hapus Mahasiswa</b> jika ingin mereset Siswa yang telah mengikuti ujian.<br>
        Hanya jawaban soal Essay yang bisa di koreksi.<br>
        Penilaian Soal Pilihan Ganda Sistem yang mengerjakan.</div>";
...
case "editkoreksi":
    if ($_SESSION[leveluser]=='admin'){
        ...
        if (!empty($pilganda) AND !empty($esay)){
            ...
            $cek=mysql_num_rows($jawaban);
            if (!empty($cek)){
                echo "<h2>Jawaban Soal Essay Mahasiswa <b>$s[nama_lengkap]</b></h2><hr>";
                $no=1;
                while ($j=mysql_fetch_array($jawaban)){
                    $soal_esay2 = mysql_query("SELECT * FROM quiz_esay WHERE id_tq='$j[id_tq]' AND id_quiz='$j[id_quiz]'");
                    $quiz = mysql_fetch_array($soal_esay2);
...
case "tambahtopikquiz":
    ...
    <dt><label>Info Tugas</label></dt>                <dd> <textarea name='info' id='wysiwyg' class='medium' rows='6'></textarea></dd>
    <dt><label>Terbit</label></dt>             <dd> <label><input type=radio name='terbit' value='Y'>Y</input></label>
                                           <label><input type=radio name='terbit' value='N'>N</input></label></dd>
    </dl>
...
case "edittopikquiz":
    ...
    <dt><label>Waktu Pengerjaan</label></dt>   <dd>: <input type=text name='waktu' size='10' value='$waktu'>
                                                     <small>Dalam Menit</small></dd>
    <dt><label>Info Tugas</label></dt>               <dd> <textarea name='info' id='wysiwyg' class='medium' rows='6'>$t[info]</textarea></td></tr>";
    if ($t[terbit]=='N'){
    ...
    <dt><label>Info Tugas</label></dt>                <dd> <textarea name='info' id='wysiwyg' class='medium' rows='6'>$t[info]</textarea></dd>";
    if ($t[terbit]=='N'){
      echo "<dt><label>Terbit</label></dt>      <dd> : <label><input type=radio name='terbit' value='Y'> Y</label>
                                           <label><input type=radio name='terbit' value='N' checked> N </label></dd>";
    }
...
case "daftartopik":
    if ($_SESSION[leveluser]=='siswa'){
        ...
        if (!empty($cek_topik)){
            echo"<br><b class='judul'>Daftar Tugas / Quiz Mata Kuliah $data_mapel[nama]</b><br><p class='garisbawah'></p>
              <table>
              ...
              while($t=mysql_fetch_array($topik)){
                  ...
                  echo"<tr><td rowspan=6>$no</td><td><b>Judul</b></td><td><b>: $t[judul]</b></td></tr>
                       ...
                       echo"<tr><td><b>Waktu Pengerjaan</b></td><td><b>: $waktu menit</b></td></tr>
                            <tr><td><b>Info Tugas</b></td><td><b>: $t[info]</b></td></tr>
...
case "daftarnilai":
    if ($_SESSION[leveluser]=='siswa'){
        ...
        if (!empty($cek_topik)){
            echo"<br><b class='judul'>Daftar Nilai Tugas Mata Kuliah $data_mapel[nama]</b><br><p class='garisbawah'></p>
              <table>
              <tr><th>No</th><th>Deskripsi Tugas OnLine</th><th></th></tr>";
              $no=1;
               while($t=mysql_fetch_array($topik)){
                  $tgl_posting   = tgl_indo($t[tgl_buat]);
                  $pengajar =  mysql_query("SELECT * FROM pengajar WHERE id_pengajar = '$t[pembuat]'");
        ...
        $cek_esay = mysql_num_rows($esay);
                ...
                elseif (empty($cek_esay)) {
                    ...
                    if (!empty($c_kerjakan)){
                        ...
                        echo"<br><b class='judul'>Nilai Anda</b><br><p class='garisbawah'></p>
                          <table>
                          <tr><th>Deskripsi Tugas OnLine</th><th>Nilai</th></tr>";
                    ...
                    elseif (empty($c_kerjakan)){
                            echo"<br><b class='judul'>Nilai Anda</b><br><p class='garisbawah'></p>
                              <table>
                              <tr><th>Deskripsi Tugas </th><th>Nilai</th></tr>";
...
case "buatquiz":
    if ($_SESSION[leveluser]=='admin'){
        ...
        echo "<form><fieldset>
          ...
          <p align=center'>
          <input class='button white' type=button value='Buat Tugas Esay' onclick=\"window.location.href='?module=buatquizesay&act=buatquizesay&id=$t[id_tq]';\">
          <input class='button white' type=button value='Buat Tugas Pilihan Ganda' onclick=\"window.location.href='?module=buatquizpilganda&act=buatquizpilganda&id=$t[id_tq]';\">
          </p>
          <br><input class='button blue' type=button value=Kembali onclick=self.history.back()>
          </fieldset></form>";
    }
...
case "buatquizesay":
    if ($_SESSION[leveluser]=='admin'){
        ...
        <input type=hidden name=id value='$_GET[id]'>
        <fieldset>
        <legend>Buat Tugas Essay</legend>
        <dl class='inline'>
...
case "buatquizpilganda":
    if ($_SESSION[leveluser]=='admin'){
        ...
        echo"<fieldset>
             <legend>Buat Tugas Pilihan Ganda</legend>
             <dl class='inline'>
             <dt><label>Pertanyaan ".$jumlah." </label></dt> <dd><textarea name='pertanyaan' id='wysiwyg' cols='75' rows='3'></textarea></dd>
...
case "daftarquiz":
    if ($_SESSION[leveluser]=='admin'){
        ...
        echo "<form><fieldset>
          ...
          <p align=center'>
          <input type=button class='button white' value='Daftar Tugas Esay' onclick=\"window.location.href='?module=daftarquizesay&act=daftarquizesay&id=$t[id_tq]';\"> 
...
case "daftarquizesay":
    if ($_SESSION[leveluser]=='admin'){
        ...
        echo "<div class='information msg'><b>Daftar Soal Tugas Esay</b></div>
              <form><fieldset>
        ...
        echo "<input class='button blue' type=button value='Tambah Tugas Esay' onclick=\"window.location.href='?module=quiz&act=buatquizesay&id=$jq[id_tq]';\">
    ...
    elseif ($_SESSION[leveluser]=='pengajar'){
        ...
        echo "<input class='button blue' type=button value='Tambah Tugas Esay' onclick=\"window.location.href='?module=buatquizesay&act=buatquizesay&id=$jq[id_tq]';\">
              <input class='button blue' type=button value=Kembali onclick=\"window.location.href='?module=quiz';\">";
...
case "daftarquizpilganda":
    if ($_SESSION[leveluser]=='admin'){
        ...
        echo "<div class='information msg'><b>Daftar Soal Tugas Pilihan Ganda</b></div>
              <form><fieldset>
              <legend>Info Tugas</legend>
              <dl class='inline'>
              <dt><label>Judul</label></dt>          <dd>: $t[judul]</dd>
        ...
        echo "<input type=button class='button blue' value='Tambah Tugas Pilihan ganda' onclick=\"window.location.href='?module=quiz&act=buatquizpilganda&id=$jq[id_tq]';\">
...
case "editquizpilganda":
    if ($_SESSION[leveluser]=='admin'){
        ...
        <input type=hidden name=topik value='$_GET[id_topik]'>
        <fieldset>
        <legend>Edit Tugas Pilihan Ganda</legend>
        <dl class='inline'>
          <dt><label>Pertanyaan </label></dt> <dd><textarea name='pertanyaan' id='wysiwyg' cols='75' rows='3'>$q[pertanyaan]</textarea></dd>
             <dt><label>Gambar</label></dt>  <dd>";
                    if ($q[gambar]!=''){
