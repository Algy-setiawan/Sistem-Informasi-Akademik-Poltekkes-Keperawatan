    ...
    if ($_SESSION[leveluser]=='admin'){
     ...
     $posisi = $p->cariPosisi($batas);
      ...
      echo "<br><br><table id='table1' class='gtable sortable'><thead>
          <tr><th>No</th><th>NIM</th><th>Nama</th><th>Kelas</th><th>Jenis Kelamin</th>
...
case "lihatmurid":
    ...
    echo "<table>
          <tr><th>No</th><th>Nim</th><th>Nama</th><th>Jenis Kelamin</th><th>Th Masuk</th>
           <th>Aksi</th></tr>";
     $no=1;
    while ($r=mysql_fetch_array($tampil)){
       echo "<tr><td>$no</td>
...
case "tambahsiswa":
    ...
    echo "</dd>
          ...
          <dt><label>Blokir</label></dt>       <dd> : <label><input type=radio name='blokir' value='N'>checked> N</label>
