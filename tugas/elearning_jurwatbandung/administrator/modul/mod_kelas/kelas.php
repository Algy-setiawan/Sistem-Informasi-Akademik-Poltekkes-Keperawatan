  ...
  default:
    if ($_SESSION[leveluser]=='admin'){
      ...
      echo "<br><br><table id='table1' class='gtable sortable'><thead>
          <tr><th>No</th><th>Id kelas</th><th>Kelas</th><th>Kordinator</th><th></th><th>Aksi</th></tr></thead>";
    $no=1;
    ...
    elseif ($_SESSION[leveluser]=='pengajar'){
         echo"<h2>Kelas yang anda ambil</h2><hr>
         ";
         ...
         if (!empty($ketemu)){
                echo "<br><br><table id='table1' class='gtable sortable'><thead>
                <tr><th>No</th><th>Kelas</th><th></th><th></th><th>Aksi</th></tr></thead>";
    ...
    elseif ($_SESSION[leveluser]=='siswa'){
        ...
        echo "<table>
          <tr><th>No</th><th>Kelas</th><th>Kordinator</th><th></th><th>Aksi</th></tr>";
        $no=1;
    ...
    echo "<form method=POST action='$aksi?module=kelas&act=input_kelas'>
          ...
          <dt><label>Kordinator</label></dt>      <dd> : <select name='id_pengajar'>
    ...
    elseif ($_SESSION[leveluser]=='pengajar'){
        echo "<form name='form_kelas' method=POST action='$aksi?module=kelas&act=input_walikelas'>
          <fieldset>
          <legend>Kelas yang anda ambil</legend>
          <dl class='inline'>
          ...
          <dt><label>--------</label></dt>  <dd> <div id='siswa'></div></dd>
    ...
    <input type=hidden name=id value='$r[id]'>
          ...
          <dt><label>---------</label></dt> <dd>:  <select name='ketua'>";
                                      $siswa = mysql_query("SELECT * FROM siswa WHERE id_siswa = '$r[id_siswa]'");
...
case "detailkelas":
    ...
    echo "<table id='table1' class='gtable sortable'><thead>
          <tr><th>No</th><th>Kelas</th><th>Kordinator</th><th>---------</th><th>Aksi</th></tr></thead>";
    $no = 1;
    while ($r=mysql_fetch_array($detail)){
       echo "<tr>
             <td>$no</td>
