...
switch($_GET[act]){
  ...
  if ($_SESSION[leveluser]=='admin'){
    ...
    echo "<h2>Manajemen Dosen</h2><hr>
          ...
          <tr><th>No</th><th>NIDN</th><th>Username</th><th>Nama</th><th>Blokir</th><th>Aksi</th></tr></thead>";
    $no=1;
  ...
  case "tambahpengajar":
    ...
    echo "<form method=POST action='$aksi?module=admin&act=input_pengajar' enctype='multipart/form-data'>
          ...
          <dl class='inline'>
          <dt><label>NIDN</label></dt>          <dd> : <input type=text name='nip'></dd>
 ...
 case "editpengajar":
    ...
    echo "<form method=POST action=$aksi?module=admin&act=update_pengajar enctype='multipart/form-data'>
          ...
          <dl class='inline'>
          <dt><label>NIDN</label></dt>          <dd> : <input type=text name='nip' value='$r[nip]'></dd>
...
case "detailpengajar":
    ...
    if ($_SESSION[leveluser]=='admin'){
    echo "<form><fieldset>
          <legend>Detail Dosen</legend>
          <dl class='inline'>
          <dt><label>NIDN</label></dt>   <dd> : $r[nip]</dd>
    ...
    elseif ($_SESSION[leveluser]=='pengajar'){
        ...
        echo"<br><b class='judul'>Detail Dosen</b><br><p class='garisbawah'></p>";
        echo "<table>
          <tr><td rowspan='12'>";if ($r[foto]!=''){
              echo "<img src='foto_pengajar/medium_$r[foto]'>";
          }echo "</td><td>NIDN</td>  <td> : $r[nip]</td><tr>
          <tr><td>Nama Lengkap</td> <td> : $r[nama_lengkap]</td></tr>          
          <tr><td>Alamat</td>       <td> : $r[alamat]</td></tr>
          <tr><td>Tempat Lahir</td> <td> : $r[tempat_lahir]</td></tr>
          <tr><td>Tanggal Lahir</td><td> : $tgl_lahir</td></tr>";
