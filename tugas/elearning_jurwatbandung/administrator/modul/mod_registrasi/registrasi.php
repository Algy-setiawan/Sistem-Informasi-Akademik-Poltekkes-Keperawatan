  ...
  default:
    if ($_SESSION[leveluser]=='admin'){
         echo "<h2>Registrasi Siswa</h2><hr>";
          ...
          <tr><th>No</th><th>Nim</th><th>Nama</th><th>Kelas</th><th>Nama Ayah</th><th>Aksi</th></tr></thead>";
          ...
          while ($r=mysql_fetch_array($registrasi)){
              echo "<tr><td>$no.</td>
                        ...
                        <a href='$aksi?module=registrasi&act=terima&id=$r[id_registrasi]'>Terima</a></td></tr>";
          }
          echo "</table>";
    }
    break;
