...
<html lang="en">
<head>
<title>Administrator Jurwat Bandung</title>
<meta charset="utf-8">
...
<header id="top">
	<div class="container_12 clearfix">
		<div id="logo" class="grid_12">
			...
			<a id="site-title">E-Learning <span>Jurwat Bandung</span></a>
	</div>
</header>
...
<div id="login2" class="box">
	...
	<section>                
		<form method="POST"action="input_registrasi.php" onSubmit="return validasi(this)">
			<dl>
			<dt><label><a id="site-title">Keterangan : Pengisian username dan pasword harus sama, untuk merubah password bisa dilakuakan setelah login.</a></label></dt>
                               
				<p><dt><label>Nim :</label></dt></p>
                                <dd><input type="text"  name="nis" size="20" id="nis"/><span id="pesan"></span></dd>
								<dt><label>password :</label></dt>
                                <dd><input type="text"  name="password_login" size="20" id="nis"/><span id="pesan"></span></dd>
