...
if (!empty($_POST['nis']) AND !empty($_POST['password_login'])){
    $tgl_lahir = $_POST[thn_lahir].'-'.$_POST[bln_lahir].'-'.$_POST[tgl_lahir];
    mysql_query("INSERT INTO registrasi_siswa(nis,password_login,nama_lengkap,id_kelas,alamat,tempat_lahir,tgl_lahir,jenis_kelamin,agama,nama_ayah,
                                              nama_ibu,th_masuk,email)
                             VALUES ('$_POST[nis]','$_POST[password_login]','$_POST[nama]','$_POST[kelas]','$_POST[alamat]',
