<?php
  ...
  define("SQL_USER", "ccjurwat_quiz");  // username for connecting to mysql
  define("SQL_PWD","@Rahasia32"); // password for connecting to mysql
  define("SQL_DATABASE","ccjurwat_quiz"); // database where you have executed sql scripts

  define("WEB_SITE_URL","http://tugas.jurwatbandung.com/elsphpwebquiz_gold_lite_1.5.1/"); // the url where you installed this script . do not delete last slash  
  ...
  define("SHOW_MENU","registered"); // all = all users , registered = registered users  , nobody = menu will be enable
  define("SHOW_MENU_ON_LOGIN_PAGE", "no"); // yes , no

  define("SITE_TEMPLATE", "gold"); // gold  , standard
  ...
  $PAGE_HEADER_TEXT= "Quiz Jurusan Keperawatan Bandung"; //only in gold and green templates
  define("HEADER_TEXT_LINK", "http://tugas.jurwatbandung.com/elsphpwebquiz_gold_lite_1.5.1/");
  $PAGE_SUB_HEADER_TEXT="www.jurwatbandung.com"; //only in gold and green templates
